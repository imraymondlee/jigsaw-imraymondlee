...
@section('content')
  ...
  <section>
    ...
    <p>As the website contained a lot of pages, there was a challenge to audit and make changes to every page. Rather than trying to go through every single page, which would take a lot of time, I focused on high traffic pages based on results from Google Analytics. By focusing on high traffic pages, there will be more opportunities for users to benefit from the improvements. The audit included checking for things such as keyboard navigability, assistive technology compatibility, and visual issues. Findings from the audit included certain components on a page not being able to be accessed through a keyboard, screen readers not properly reading content, and insufficient colour contrast.</p>
